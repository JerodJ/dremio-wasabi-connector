...
@SourceType(value = "WasabiARP", label = "Wasabi",uiConfig = "wasabi-layout.json")
public class WasabiConf extends AbstractArpConf<WasabiConf> {
  private static final String ARP_FILENAME = "arp/implementation/wasabi-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.wasabi.WasabiDriver";
